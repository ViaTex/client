...
function StatusBadge({ status }: { status: string }) {
    return (
        <span className="inline-flex rounded-full bg-[#dfeafe] px-3 py-1 text-xs font-semibold text-[#2856b6] dark:bg-[#1c2c5c] dark:text-[#bcd3ff]">
            {status}
        </span>
    )
}
            ...
            >
                <div className="flex flex-col gap-3 lg:flex-row">
                    ...
                    <div className="relative w-full lg:w-[300px]">
                        ...
                        >
                            <option value="all_applications">All Applications (0)</option>
                        </select>
            ...
            >
                <div className="overflow-x-auto">
                    <table className="min-w-full">
                        ...
                        <tbody>
                            <tr className="border-b border-[#edf1f8] dark:border-[#25345d]">
                                <td className="px-5 py-5">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="min-w-0">
                                            <p className="text-[0.96rem] font-semibold text-[#111827] dark:text-white">Not specified</p>
                                            <p className="text-[0.88rem] text-[#5f6f98] dark:text-[#b8c5e6]">Not specified</p>
                                        </div>
                                    </div>
                                </td>
                                <td className="px-5 py-5 text-[0.96rem] text-[#111827] dark:text-white">Not specified</td>
                                <td className="px-5 py-5">
