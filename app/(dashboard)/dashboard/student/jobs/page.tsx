...
export default function StudentJobsPage() {
    ...
    const filteredJobs = jobs.filter((job) => {
        ...
        const matchCompany = !selectedCompany || job.company?.toLowerCase().includes(selectedCompany.toLowerCase())
    ...
    const stats = {
        open: jobs.filter(j => j.job_type !== "Closed").length,
        closed: jobs.filter(j => j.job_type === "Closed").length,
        total: jobs.length
    }
                                    ...
                                    <div className="p-4 sm:p-5 border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-blue-50/50 to-purple-50/50 dark:from-blue-900/10 dark:to-purple-900/10">
                                        <div className="flex items-start justify-between gap-3 mb-3">
                                            <div className="flex items-center gap-3 flex-1 min-w-0">
                                                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center flex-shrink-0">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            <span className="inline-flex items-center gap-1 px-2 sm:px-3 py-1 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs sm:text-sm font-medium">
                                    ...
                                    <div className="p-4 sm:p-5 space-y-3">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                                                ...
                                                <span>•</span>
                                                <span className="text-gray-500 dark:text-gray-500">Jan 18th</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="pt-3 border-t border-gray-100 dark:border-gray-800 space-y-2">
                                            <div className="flex items-center justify-between gap-2">
                                                <h5 className="text-sm font-medium text-gray-900 dark:text-white">
                                                    {job.title ? `${job.title} - Related` : "Related Job"}
                                                </h5>
                                                <span className="text-xs text-purple-600 dark:text-purple-400 font-medium">Why i see this?</span>
                                            </div>
                                            <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                                                {job.location || "Location"} • Remote • Jan 18th
                                            </p>
                                        </div>
                                    </div>
                                </motion.div>
