    ...
    return (
        <div className="w-full font-sans text-gray-900 dark:text-gray-100 relative max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
                ...
                className="lg:col-span-5 rounded-[20px] p-6 shadow-md flex flex-col justify-between relative overflow-hidden bg-[#f9f9f9]
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                {/* List/Feed (Right) */}
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8 }} className="lg:col-span-5 bg-[#f9f9f9] dark:bg-none dark:bg-[#0B1739rounded-xl p-6 border border-gray-200 dark:bg-none dark:bg-[#0B1739] order-white/10 shadow-sm relative overflow-hidden">
